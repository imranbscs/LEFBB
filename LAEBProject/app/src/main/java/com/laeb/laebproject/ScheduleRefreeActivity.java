...
import com.laeb.laebproject.adapters.SecduleRefreeAdapter;
...
public class ScheduleRefreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schedule_refree);
        ...
        adapter = new SecduleRefreeAdapter(listItems, this);
