...
public class AdapterSabSentInvitation extends RecyclerView.Adapter<AdapterSabSentInvitation.ViewHolder> {

    List<Datum> listItems;
    public Context context;
    public static String j;

    public AdapterSabSentInvitation(List<Datum> listItems, Context context) {
        this.listItems = listItems;
        this.context = context;
    }

    @Override
    public AdapterSabSentInvitation.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recived_invitation, parent, false);
        return new AdapterSabSentInvitation.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AdapterSabSentInvitation.ViewHolder holder, int position) {
...
//        holder.day.setText(obj.getTeamA().toString());
//        holder.month.setText(obj.getTeamB().toString());
